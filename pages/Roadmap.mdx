...
Develop a small-scale AI-generated NFT platform and Basic collection-based NFT Marketplace For Buy And Sell NFT Collections.

- [ ] `AIFT` : allows users to easily create unique digital art using AI algorithms with just a prompt. These AI-generated artworks can be minted as AI collection on Poply, offering both creators and collectors a new dimension of artistic exploration and potential revenue sharing.
...
- [ ] `Poply Native Collection` : This is the native collection of Poply that has a lot of benefits for its holders.
- [ ] `Community building` Our launchpad feature fosters community building by providing a platform for like-minded individuals to discover and participate in token sales and NFT launches.
